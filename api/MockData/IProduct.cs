namespace SnusBolaget.API.MockData
{
 ...
 new Product  {
     Id = 3, Name = "General", Type = "Portion", NicotineAmount = "8,5 mg/g", Description = "General, tidigare kallat Generalsnus, framställs av Swedish Match. Det är en av Sveriges genom tiderna största titlar med långa och anor. Generals snus görs på en blandning av över 20 olika tobakssorter som kompletteras med bergamottolja. Smakerna i sortimentet innehåller även peppar och en antydan av citrus. General finns i alla möjliga former; General Lös, General Portion, General Mini, General White, General XR och även som stark snus.", Price = 50, StarRating = 3.2, ImageUrl = "https=//media.snusbolaget.se/snusbolaget/images/swm-880-2020-10-12-103510322/555/555/0/general-portionssnus.png", NicotineLevel = "8.5mg/g", Taste = "Traditionell", ContentWeight = "24", ContentWeightUnit = "g", Producer = "Swedish Match"},
  new Product
  {Id = 4, Name = "Göteborgs Rapé", Type = "Portion", NicotineAmount = "8,5 mg/g", Description = "Snus från Göteborgs Rapé har en lång historia, snuset har sålts i Sverige ända sedan 1919. Göteborgs Rapé-snuset har en speciell karaktär med en mild tobakssmak och viss sötma. Det har även inslag av färska örter och enbär. Göteborgs Rapé tillverkas av Swedish Match och finns tillgängligt i en mängd olika varianter.", Price = 50, StarRating = 3.5, ImageUrl = "https=//media.snusbolaget.se/snusbolaget/images/swm-874-2018-05-17-134527613/555/555/0/goteborgs-rape-white-portionssnus.png", NicotineLevel = "8.5mg/g", Taste = "Traditionell", ContentWeight = "24", ContentWeightUnit = "g", Producer = "Swedish Match"},
 new Product {
     Id = 5, Name = "Röda Lacket", Type = "Portion", NicotineAmount = "8,5 mg/g", Description = "50% snus, 45% jenkasmak 5% barrsmak", Price = 67.49, StarRating = 3.5, ImageUrl = "https=//media.snusbolaget.se/snusbolaget/images/swm-808-2017-04-11-114503959/555/555/2/roda-lacket-lossnus.png", NicotineLevel = "8.5mg/g", Taste = "Traditionell", ContentWeight = "24", ContentWeightUnit = "g", Producer = "Swedish Match"},
        };
    }
